...
See [Writing Security Rules](../../operator/writing-rules) for many examples.
...
See the [SecLang Structure reference](../seclang-structure) for the full list of supported variables, collections, and operators.
