...
Copy the entire content of [`kubewaf-secrule-expert.md`](kubewaf-secrule-expert) and paste it at the beginning of your conversation (or add it to your custom instructions / project rules).
...
See the main guide [Writing Security Rules](../operator/writing-rules#writing-rules-with-ai-assistance) for more context and examples of the AI-assisted flow.
