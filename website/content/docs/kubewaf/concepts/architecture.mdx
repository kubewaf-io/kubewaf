...
in front via [`spec.challenge`](../operator/challenge).
...
See [Data plane (ECDS)](../operator/dataplane-ecds) for configuration details.
...
- [WAF engine (kubeWAF)](../operator/engine) · [modsecurity-proxy-wasm](../modsecurity-proxy-wasm)
- [PoW challenge (kubeWAF)](../operator/challenge) · [pow-proxy-wasm](../pow-proxy-wasm)
- [Envoy Gateway](https://gateway.envoyproxy.io/)
- [Istio EnvoyFilter](https://istio.io/latest)
- [Cilium Envoy](https:/.cilium.io/en/stable/network/servicemesh/envoy/)
