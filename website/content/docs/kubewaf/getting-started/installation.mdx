...
<Callout type="warn" title="Wasm modules">
...
See [WAF engine](../operator/engine), [challenge](../operator/challenge), and [Data plane](../operator/dataplane-ecds#wasm-binary-delivery-multi-module).
</Callout>
...
See [Envoy Gateway guide](../operator/envoy-gateway#configure-envoy-gateway-extension-server).
...
- See [Architecture · Multi-replica](../concepts/architecture#operator-internals)
...
objects and re-apply `WAF` CRs ([migration](../operator/dataplane-ecds#migration-from-envoyextensionpolicy)).
...
2. [Data plane setup](../operator/dataplane-ecds)  
3. Provider guide: [Envoy Gateway](../operator/envoy-gateway) · [Istio](../operator/istio) · [Cilium](../operator/cilium)
