...
- Operator wasm serve: `challengeWasmFile` / `challengeWasmSourceURL`  
- [kubeWAF challenge guide](/docs/kubewaf/operator/challenge)  
- [kubeWAF troubleshooting](/docs/kubewaf/troubleshooting)  
