# AI-Assisted SecRule Creation for kubeWAF
...
Copy the entire content of [`kubewaf-secrule-expert.md`](kubewaf-secrule-expert.md) and paste it at the beginning of your conversation (or add it to your custom instructions / project rules).
