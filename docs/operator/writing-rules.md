...
1. Copy the content of [`docs/ai/kubewaf-secrule-expert.md`](https://github.com/kubewaf-io/kubewaf/blob/main/docs/ai/kubewaf-secrule-expert.md) and paste it into your conversation or project rules.
...
See [`docs/ai/README.md`](https://github.com/kubewaf-io/kubewaf/blob/main/docs/ai/README.md) for usage instructions for different AI tools.
...
1. Use the `crs-converter` tool (see [Using CRS](using-crs.md))
...
Now that you can write individual rules, learn how to [organize them with RuleSets](rulesets.md).